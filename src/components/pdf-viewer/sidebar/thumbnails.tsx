...
export default function Thumbnails({ pdfUrl, currentPage, numPages, onPageClick, isDarkTheme }: ThumbnailsProps) {
  ...
  return (
    <div className="h-full w-full overflow-y-auto p-2" style={{ backgroundColor: isDarkTheme ? "#0f0423" : "#f8f9fa" }}>
      <h3 className="mb-3 px-2 text-xs font-medium" style={{ color: accentColor }}>
        Páginas
      </h3>
        ...
        <Document file={pdfUrl} onLoadSuccess={onDocumentLoadSuccess} onLoadError={onDocumentLoadError} loading={null}>
          {Array.from(new Array(numPages), (_, index) => (
            <motion.div
              ...
              style={{
                backgroundColor: isDarkTheme ? "#0f0423" : "#f8f9fa",
              }}
            ...
            >
              <Page
                ...
                loading={
                  <div
                    ...
                    style={{ backgroundColor: isDarkTheme ? "#151525" : "#eee" }}
                  >
                    <motion.div
                      animate={{
                        rotate: 360,
              ...
              <div
                ...
                style={{ backgroundColor: isDarkTheme ? "#151525" : "#eee", color: accentColor }}
              >
                {index + 1}
              </div>
            </motion.div>
